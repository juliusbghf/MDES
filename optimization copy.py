...
def start_optimization(product_1: pd.DataFrame, product_2: pd.DataFrame, product_3: pd.DataFrame):
    ...
    fig = px.timeline(gantt_df, x_start="Start", x_end="Finish", y="Resource", color="Product", title="Gantt Chart", color_discrete_map=color_map, hover_data=["Label"], text="Label")
